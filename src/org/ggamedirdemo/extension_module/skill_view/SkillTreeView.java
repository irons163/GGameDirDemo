...
//				linesPts.add(conditionSkillView.locationInSceneByCompositeLocation(conditionSkillView.getCenterX(), conditionSkillView.getCenterY()).x);
				linesPts.add(conditionSkillView.getLocationInScene().x + conditionSkillView.getWidth()/2);
				linesPts.add(conditionSkillView.getLocationInScene().y + conditionSkillView.getHeight()/2);
				linesPts.add(skillView.getLocationInScene().x + skillView.getWidth()/2);
				linesPts.add(skillView.getLocationInScene().y + skillView.getHeight()/2);
			}
		}
	}

...
public class TransformScene extends EasyScene{
...
//	}
	...
	public TransformScene(final Context context, String id, int level, int mode) {
		...
		runMovementAction(MAction.repeatFaster(MAction2.sequence(new MovementAction[]{MAction.waitAction(3), MAction.runBlock(new MAction.MActionBlock() {
			
			@Override
			public void runBlock() {
				// TODO Auto-generated method stub
				TransformScene.this.setRotation(TransformScene.this.getRotation()+30);
			}
		})}), 20));
